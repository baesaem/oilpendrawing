...
export const STYLE_DESC: Record<PenStyle, string> = {
  tonehatch: '사진을 밝기 여러 단계(기본 10, 최대 15)로 나누고 단계마다 한 방향 펜선을 얹습니다. 가장 밝은 단계는 흰 종이로 비우고, 어두운 단계일수록 선이 굵고 촘촘해지며 셋째 단계부터 교차선이 됩니다. 스케치북에 그대로 따라 그리기 가장 쉬운 방식입니다.',
  ...
  hatching: '펜으로 형태와 명암을 한 방향 평행선으로 잡고, 지붕·문·나무처럼 눈길이 가는 곳에만 색을 얹는 방식입니다. 흰 종이가 많이 남아 가볍고, 색이 들어간 자리가 주인공이 됩니다.',
