...
- **선·톤 패널**에서 채우기(어반 스케치·한 방향·교차·윤곽·스크리블·점묘), 톤 단계, 여백, 선 굵기, 윤곽선 밀도, 해칭 각도·간격, 손떨림, 가장자리 여백, 낙관·날짜, 종이·잉크색을 조절합니다. 움직이면 결과가 바로 다시 그려집니다.
- **참고 작가 프리셋** 두 가지가 기본으로 들어 있습니다.
  - **리천 스타일** ([@richeons_drawing_journey](https://www.instagram.com/richeons_drawing_journey/), 기본값): 가는 검정 펜, 면의 방향을 따르는 해칭(벽은 세로, 바닥은 원근 방향), 나뭇잎은 고리 선 뭉치, 하늘과 하이라이트는 흰 종이, 가장자리는 미완성으로 흐려짐, 오른쪽 아래 붉은 낙관 "梨川"과 날짜.
  - **박용순 스타일** ([@parkyongsoon_art](https://www.instagram.com/parkyongsoon_art/)): 아주 가는 선으로 종이 끝까지 완성, 수평 하늘 해칭 속 흰 구름, 깊은 그림자는 먹으로, 잔결 질감.
